...
{if $enablecategorization}
    ...
    {foreach from=$propertiesdata item='property'}
        ...
        {foreach from=$category.subcategories item='category'}
            ...
            {array_field_isset assign='categoryname' array=$category.category.display_name field=$lang returnValue=1}
            {if $categoryname eq ''}{assign var='categoryname' value=$category.category.name}{/if}
            {array_field_isset assign='categorydesc' array=$category.category.display_desc field=$lang returnValue=1}
            ...
            <li>
                ...
                {foreach from=$category.subcategories item='subcat'}
                    {array_field_isset assign='categoryname' array=$subcat.category.display_name field=$lang returnValue=1}
                    {if $categoryname eq ''}{assign var='categoryname' value=$subcat.category.name}{/if}
                    {array_field_isset assign='categorydesc' array=$subcat.category.display_desc field=$lang returnValue=1}
