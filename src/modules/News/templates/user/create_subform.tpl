...
{/if}
    <div>
        ...
        <fieldset>
            ...
            *}
            ...
            <div class="z-formrow">
                ...
                {array_field_isset assign='selectedValue' array=$item.__CATEGORIES__ field=$property returnValue=1}
        ...
        <fieldset>
            ...
            <div id="news_publication_details">
                <div class="z-formrow">
                    ...
                    <input id="news_hideonindex" name="story[hideonindex]" type="checkbox" value="1" {if $item.hideonindex eq 1}checked="checked" {/if}/>
                </div>
                <div class="z-formrow">
        ...
        <div class="z-buttonrow z-buttons z-center">
            ...
            <a id="news_button_cancel" href="{modurl modname='News' type='user' func='main'}" class="z-btred">{img modname='core' src='button_cancel.png' set='icons/extrasmall' __alt='Cancel' __title='Cancel'} {gt text='Cancel'}</a>
        </div>
    </div>
</form>