...
function News_init()
{
    ...
    pnModSetVar('News', 'permalinkformat', '%year%/%monthnum%/%day%/%articletitle%');
    ...
    pnModSetVar('News', 'enablecategorybasedpermissions', true);
    pnModSetVar('News', 'enabledescriptionvar', false);
    ...
    pnModSetVar('News', 'picupload_maxfilesize', '500000');
    ...
    pnModSetVar('News', 'picupload_uploaddir', 'images/news_picupload');
...
function News_upgrade($oldversion)
{
    ...
    switch ($oldversion)
    {
        ...
        case '2.5.2':
            ...
            // add new category based permission check var
            pnModSetVar('News', 'enablecategorybasedpermissions', true);
            
            // permalink format change story to article
            pnModSetVar('News', 'permalinkformat', str_replace(array('storytitle', 'storyid'), array('articletitle', 'articleid'), pnModGetVar('News', 'permalinkformat')));
        ...
        case '2.5.3':
        case '2.6.0':
            // remove spaces from the allowed picture upload extensions
            pnModSetVar('News', 'picupload_allowext', str_replace(' ', '', pnModGetVar('News', 'picupload_allowext')));
