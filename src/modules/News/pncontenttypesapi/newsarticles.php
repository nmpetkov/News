...
class News_contenttypesapi_NewsArticlesPlugin extends contentTypeBase
{
  ...
  function display()
  {
    ...
    $render->assign('useshorturls', (pnConfigGetVar('shorturls') && pnConfigGetVar('shorturlstype') == 0));
  ...
  function displayEditing()
  {
    ...
    if (!empty($catname)) {
        ...
        $output .= '<p>' . __f('News articles listed without a category selection', $dom) . '</p>';
    }
    return $output;
  }
